...
pub const JA_ME_HELP_BODY: &str = "入室できない場合やアクセスを失った場合は、コミュニティの管理者にお問い合わせください。";
...
pub const EN_ADMIN_CANNOT_EDIT_STARTED: &str = "This event has already started and cannot be edited.";
pub const EN_ADMIN_CANNOT_ATTEND_CANCELLED: &str = "Attendance cannot be corrected for a cancelled event.";
...
pub const JA_ADMIN_CANCEL_EVENT_BODY: &str = "メンバーにはキャンセルされたことが引き続き表示されます。";
...
pub const JA_ADMIN_CANNOT_EDIT_STARTED: &str = "このイベントはすでに開始しているため編集できません。";
pub const JA_ADMIN_CANNOT_ATTEND_CANCELLED: &str = "キャンセル済みのイベントの出席は修正できません。";
...
pub const EN_ADMIN_INVITES_NEW_CODE_HINT: &str = "Share with one person only — expires in 24 hours.";
...
pub const JA_ADMIN_INVITES_NEW_CODE_HINT: &str = "一人だけに共有してください — 24時間で失効します。";
...
pub const EN_ADMIN_LAST_ADMIN: &str = "Cannot remove the last admin. Transfer the admin role first.";
...
pub const JA_ADMIN_REMOVE_CONSEQUENCE: &str = "このメンバーはイベントやメモを見ることができなくなります。";
pub const JA_ADMIN_LAST_ADMIN: &str = "最後の管理者は削除できません。先に管理者権限を移譲してください。";
...
mod tests {
    ...
    fn en_ja_parity() {
        let en_keys = &[
            // Join
            "JOIN_HEADING", "JOIN_SUBHEADING", "JOIN_CODE_LABEL", "JOIN_CODE_HINT",
            "JOIN_SUBMIT", "JOIN_PROFILE_HEADING", "JOIN_PROFILE_HINT",
            "JOIN_PROFILE_LABEL", "JOIN_PROFILE_SUBMIT",
            // Status
            "STATUS_GOING", "STATUS_NOT_GOING", "STATUS_ATTENDED", "STATUS_NO_ANSWER",
            "STATUS_ATTENDED_DISABLED", "STATUS_CLEAR", "STATUS_CLEAR_LABEL",
            // Note
            "NOTE_SAVE", "NOTE_DELETE", "NOTE_SAVED", "NOTE_TOO_LONG",
            "NOTE_SECTION_LABEL", "NOTE_PLACEHOLDER_LABEL", "NOTE_CHAR_HINT",
            "NOTE_VISIBILITY",
            // Session/auth
            "SESSION_EXPIRED", "LOGOUT", "LOGOUT_CONFIRM",
            // General
            "GENERAL_ERROR", "OFFLINE_BANNER",
            "EMPTY_EVENTS", "EMPTY_EVENTS_HINT", "EMPTY_EVENTS_ADMIN",
            // Nav
            "NAV_HOME", "NAV_COMMUNITIES", "NAV_ME",
            // Home
            "HOME_TODAY", "HOME_THIS_WEEK", "HOME_LATER",
            "HOME_CREATE_EVENT", "HOME_INVITE_MEMBERS",
            // Me
            "ME_SECTION_NAME", "ME_SECTION_COMMUNITY", "ME_SECTION_HELP", "ME_HELP_BODY",
            // Admin: events
            "ADMIN_CREATE_EVENT_TITLE", "ADMIN_CREATE_EVENT_SUBMIT",
            "ADMIN_EDIT_EVENT_TITLE", "ADMIN_EDIT_EVENT_SUBMIT", "ADMIN_EDIT_EVENT_HINT",
            "ADMIN_CANCEL_EVENT_TITLE", "ADMIN_CANCEL_EVENT_BODY",
            "ADMIN_CANCEL_EVENT_KEEP", "ADMIN_CANCEL_EVENT_CONFIRM",
            "ADMIN_CANNOT_EDIT_CANCELLED", "ADMIN_CANNOT_EDIT_STARTED",
            "ADMIN_CANNOT_ATTEND_CANCELLED",
            "ADMIN_ATTEND_TITLE", "ADMIN_ATTEND_SUBMIT",
            // Admin: invites
            "ADMIN_INVITES_TITLE", "ADMIN_INVITES_BODY", "ADMIN_INVITES_GENERATE",
            "ADMIN_INVITES_ACTIVE", "ADMIN_INVITES_NONE", "ADMIN_INVITES_NEW_CODE_HINT",
            "ADMIN_INVITES_REVOKE", "ADMIN_INVITES_REVOKED",
            // Admin: members
            "ADMIN_MEMBERS_TITLE", "ADMIN_MEMBERS_GENERATE_INVITE",
            "ADMIN_REMOVE_TITLE", "ADMIN_REMOVE_KEEP", "ADMIN_REMOVE_CONFIRM",
