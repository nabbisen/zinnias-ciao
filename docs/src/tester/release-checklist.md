...
- [~] Hosted Cloudflare staging smoke executed and evidence attached. *(operator task: deploy staging with `BUILD_VERSION` set to the release label, then `EXPECTED_VERSION=v0.61.0 bun run smoke:runtime -- <deployed-worker-url>`)*
