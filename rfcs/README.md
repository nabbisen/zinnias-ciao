...
| 080 | [External Identity Foundation](./accepted/080-external-identity-foundation.md) | 2026-08-09 | Stage 1 of the external-identity track; chooses **no provider**. Design only — **acceptance confers no implementation authority**, and Stage 2 (recovery and membership continuity) must be accepted before implementation begins. Follows the 2026-07-17 pre-RFC consultation and the 2026-08-09 hold-lift |
