...
**Status.** Implemented (v0.10.0) — EN/JA string table complete; language selection per community is post-MVP (RFC-026 §3 deferred). All user-visible strings wired to i18n constants; parity lint enforced.
