...
/// Returns a UTC ISO-8601 string `days_ahead` calendar days after today,
/// at midnight UTC — used for the Home window upper bound.
...
// Minimal Gregorian decomposition (valid 1970–2099, no external crate needed).
